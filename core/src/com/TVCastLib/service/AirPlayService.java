 ...
 * Created by Hamed Ghaderipour on 18 Apr 2014
 * 
...
import com.TVCastLib.service.airplay.PListBuilder;
import com.TVCastLib.service.airplay.PListParser;
        ...
        Util.runInBackground(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    connection.setHeader(HTTP.USER_AGENT, "TVCastLib MediaControl/1.0");
