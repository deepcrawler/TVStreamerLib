 ...
 * 
 * The TVCastLib JavaScript Bridge has been produced to provide normalized
...
public class WebAppSession implements MediaControl, MediaPlayer, PlaylistControl {
    ...
    /**
     * Sends a simple string to the web app. The TVCastLib JavaScript Bridge
    ...
    /**
     * Sends a JSON object to the web app. The TVCastLib JavaScript Bridge
