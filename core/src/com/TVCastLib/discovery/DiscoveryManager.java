...
import com.TVCastLib.DefaultPlatform;
import com.TVCastLib.core.Util;
import com.TVCastLib.device.ConnectableDevice;
import com.TVCastLib.device.ConnectableDeviceListener;
import com.TVCastLib.device.ConnectableDeviceStore;
import com.TVCastLib.device.DefaultConnectableDeviceStore;
import com.TVCastLib.service.CastService;
import com.TVCastLib.service.DLNAService;
import com.TVCastLib.service.DeviceService;
import com.TVCastLib.service.DeviceService.PairingType;
...
import com.TVCastLib.service.config.ServiceConfig.ServiceConfigListener;
 ...
 * ###Overview
 *
 * At the heart of TVCastLib is DiscoveryManager, a multi-protocol service discovery engine with a pluggable architecture. Much of your initial experience with TVCastLib will be with the DiscoveryManager class, as it consolidates discovered service information into ConnectableDevice objects.
 *
 * ###In depth
...
public class DiscoveryManager implements ConnectableDeviceListener, DiscoveryProviderListener, ServiceConfigListener {
    ...
    public static String TVCast_Lib_VERSION = "1.6.0";
    ...
    /**
     * Listener which should receive discovery updates. It is not necessary to set this listener property unless you are implementing your own device picker. TVCastLib provides a default DevicePicker which acts as a DiscoveryManagerListener, and should work for most cases.
     *
     ...
     *
     * To disable the ConnectableDeviceStore capabilities of TVCastLib, set this value to nil. This may be done at the time of instantiation with `DiscoveryManager.init(context, null);`.
     */
...
//        device.setLastSeenOnWifi(currentSSID);
    ...
    public void addServiceDescriptionToDevice(ServiceDescription desc, ConnectableDevice device) {
        ...
        if(desc.getFriendlyName().toUpperCase(Locale.US).contains("WEBOS") && deviceServiceClass!= WebOSTVService.class)
            return;

//        if(desc.getFriendlyName().toUpperCase(Locale.US).contains("CHROMECAST") && deviceServiceClass== DIALService.class){
//            desc.setServiceFilter(CastService.ID);
//            desc.setServiceID("Cast");
//            deviceServiceClass=CastService.class;
//        }
    ...
    // @endcond
    public void setChromecastAppId(String appId){
        CastService.setApplicationID(appId);
    }
}
